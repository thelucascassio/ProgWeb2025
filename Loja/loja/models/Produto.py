...
class Produto(models.Model):
    ...
    related_name='categoria', on_delete=models.SET_NULL) #foreign key: chave estrangeira, número que representa a entidade que está sendo relacionada a esta fóri ki
